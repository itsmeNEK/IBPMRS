      ...
      <div class="col-md-12">
        <div class="p-4">
          <div class="text-center">
            ...
            <center><h3>Your email is already verified.</h3></center><br>
            <h5>Please let me know if you have any questions or would like further information, otherwise, no response is needed.</h5>
            <h5>Thank You!</h5><br>
            <h6>You may now login to your account.</h6>
            <a class="btn btn-primary btn-sm" href="<?php echo base_url();?>index.php">Click Here to Login...</a>
            <br><br>
